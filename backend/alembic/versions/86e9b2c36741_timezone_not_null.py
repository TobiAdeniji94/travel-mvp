...
Revision ID: 86e9b2c36741
Revises: a407221c898d
Create Date: 2025-08-03 22:48:56.932526
...
revision: str = '86e9b2c36741'
down_revision: Union[str, Sequence[str], None] = 'a407221c898d'
...
def upgrade() -> None:
    """Upgrade schema."""
    # NOTE: This migration was generated at the same time as a407221c898d and contains
    # duplicate operations. All schema changes were already applied in a407221c898d.
    # This migration is kept as a no-op to maintain the migration chain integrity.
    pass


def downgrade() -> None:
    """Downgrade schema."""
    # NOTE: This migration is a no-op, so downgrade is also a no-op
    pass
    ...
    op.add_column('destinations', sa.Column('created_at', sa.DateTime(timezone=False), nullable=False, server_default=text('now()'),),)
    op.add_column('destinations', sa.Column('updated_at', sa.DateTime(timezone=False), nullable=False, server_default=text('now()'),),)
    op.add_column('destinations', sa.Column('is_deleted', sa.Boolean(), nullable=False, server_default=text('false'),),)
    op.add_column('destinations', sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True))
    op.alter_column('destinations', 'created_at', server_default=None)
    op.alter_column('destinations', 'updated_at', server_default=None)
    op.alter_column('destinations', 'is_deleted', server_default=None)
    ...
    op.add_column('itineraries', sa.Column('updated_at', sa.DateTime(timezone=False), nullable=False, server_default=text('now()'),),)
    op.add_column('itineraries', sa.Column('is_deleted', sa.Boolean(), nullable=False, server_default=text('false'),),)
    op.add_column('itineraries', sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True))
    op.alter_column('itineraries', 'updated_at', server_default=None)
    op.alter_column('itineraries', 'is_deleted', server_default=None)
    ...
    op.add_column('users', sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False, server_default=text('now()'),),)
    op.add_column('users', sa.Column('is_deleted', sa.Boolean(), nullable=False, server_default=text('false'),),)
